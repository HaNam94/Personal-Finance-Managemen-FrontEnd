              ...
              <div className="col-4">
                  <div className="bg-white shadow-sm p-3 rounded-3  mb-2">
                      <div className="text-center">
                          ...
                          <h3 className="fw-bold"><FormattedNumber value={totalBudget - totalAmount} style="currency" currency={uCurrency}/></h3>
                      </div>
                      <SemiChart percent={Number(((totalAmount / totalBudget) * 100).toFixed(2))}/>

                      <div className="d-flex justify-content-between mt-4">
                          <div className="text-center">
                              <h5 className="fw-bold"><FormattedNumber value={totalBudget} style="currency" currency={uCurrency}/></h5>
                              <p className="mb-1">Tổng</p>

                          </div>
                          <div className="text-center">
                          <h5 className="fw-bold"><FormattedNumber value={totalAmount} style="currency" currency={uCurrency}/></h5>
